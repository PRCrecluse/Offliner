...
const translations = {
    en: {
        ...
        "hosts.hero_title": "Create Event & Invite Friends",
        "hosts.hero_subtitle": "One tap to launch your dedicated event page.",
        "hosts.f1_title": "Clear Stats",
        "hosts.f1_desc": "Instant data insights.",
        "hosts.f2_title": "Real-time Alerts",
        "hosts.f2_desc": "Instant notification on sign-ups.",
        "hosts.f3_title": "Easy Redemption",
        "hosts.f3_desc": "Ticket image redemption for all.",
        "nav.hosts_sec1": "Website",
        "nav.hosts_sec2": "Notifications",
        "nav.hosts_sec3": "Check-in",
        "nav.hosts_sec4": "Export",
        "hosts.sec1_title": "Instant Event Site",
        "hosts.sec1_desc": "Zero-code. Templates included. Get a site instantly.",
        "hosts.sec2_title": "Real-time Alerts",
        "hosts.sec2_desc": "SMS & Email alerts. Notify attendees instantly.",
        "hosts.sec3_title": "Free Check-in & Stats",
        "hosts.sec3_desc": "QR/Phone check-in. Auto-stats & visual reports.",
        "hosts.sec4_title": "1-Click Export",
        "hosts.sec4_desc": "Sync & export attendee data to Excel/Word."
    },
    zh: {
        "nav.for_users": "我是用户",
        "nav.for_hosts": "我是主办方",
